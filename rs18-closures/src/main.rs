...
// Closures capture values from their environment by three ways:
// 1- by taking ownership
// 2- by borrowing mutably
// 3- by borrowing immutably
// FnOnce - Take ownership, FnMut - mutably borrows, Fn - Immutably borrows
// move || {} takes ownership of the value
